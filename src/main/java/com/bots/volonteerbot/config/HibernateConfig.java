package com.bots.volonteerbot.config;
...
@EnableJpaRepositories("com.bots.volonteerbot.persistence.repository")
public class HibernateConfig {
    ...
    private static final String ENTITY_MANAGER_PACKAGES_TO_SCAN = "com.bots.volonteerbot.persistence.entity";
